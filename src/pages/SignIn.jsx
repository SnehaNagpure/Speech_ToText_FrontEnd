...
export default function SignIn() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error('Login failed: ' + (err.response?.data?.message || err.message)); // ✅ Error toast
    }
  };
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-md">
          ...
          <div className="mb-10 text-center">
            ...
            <p className="text-gray-600 text-base md:text-lg">
              🎙️Stop typing. Start talking. Our AI-powered transcription technology converts your voice to text with stunning accuracy in seconds.
            </p>
          </div>
          ...
          <p className="mt-4 text-sm text-gray-700 text-center">
            ...
            <Link className="text-gray-900 font-medium hover:underline" to="/signup">
              Sign Up
            </Link>
          </p>
        </form>
